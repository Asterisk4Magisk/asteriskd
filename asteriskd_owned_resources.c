...
static const struct asteriskd_owned_chain owned_chains[] = {
    ...
    {ASTERISKD_IP_FAMILY_IPV4, ASTERISKD_IP_TABLE_MANGLE,
        "ASTERISKD_LOCAL4_BEGIN"},
    {ASTERISKD_IP_FAMILY_IPV4, ASTERISKD_IP_TABLE_MANGLE,
        "ASTERISKD_LOCAL4_END"},
    {ASTERISKD_IP_FAMILY_IPV4, ASTERISKD_IP_TABLE_MANGLE,
    ...
    {ASTERISKD_IP_FAMILY_IPV6, ASTERISKD_IP_TABLE_MANGLE,
        "ASTERISK_TPROXY6_DUMMY_PRE"},
    {ASTERISKD_IP_FAMILY_IPV6, ASTERISKD_IP_TABLE_MANGLE,
        "ASTERISK_TPROXY6_DUMMY"},
    {ASTERISKD_IP_FAMILY_IPV6, ASTERISKD_IP_TABLE_MANGLE,
        "ASTERISKD_LOCAL6_BEGIN"},
    {ASTERISKD_IP_FAMILY_IPV6, ASTERISKD_IP_TABLE_MANGLE,
        "ASTERISKD_LOCAL6_END"},
    {ASTERISKD_IP_FAMILY_IPV6, ASTERISKD_IP_TABLE_MANGLE,
...
static const struct asteriskd_owned_hook owned_hooks[] = {
    ...
    {ASTERISKD_IP_FAMILY_IPV6, ASTERISKD_IP_TABLE_MANGLE,
        "PREROUTING", false, "ASTERISK_TPROXY6_DUMMY_PRE"},
    {ASTERISKD_IP_FAMILY_IPV6, ASTERISKD_IP_TABLE_MANGLE,
        "OUTPUT", false, "ASTERISK_TPROXY6_DUMMY"},
    {ASTERISKD_IP_FAMILY_IPV4, ASTERISKD_IP_TABLE_MANGLE,
...
static const struct asteriskd_owned_policy_rule owned_policy_rules[] = {
    ...
    {ASTERISKD_IP_FAMILY_IPV6, ASTERISKD_TPROXY_DUMMY_TABLE,
        ASTERISKD_ROUTE_RULE_PRIORITY, ASTERISKD_AUXILIARY_MARK,
        ASTERISKD_MARK_MASK, true},
